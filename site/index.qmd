...
author:
  ...
  - name: Rich Hanna
    url: https://www.linkedin.com/in/richard-hanna-ms-0164162a/
    affiliation: Children's Hospital of Philadelphia
format: 
  html:
    theme: flatly
...
This is the website for the R/Medicine 2025 pre-conference short course *Introduction to R for Clinical Data*.
...
The entire course will be recorded and made available to registered R/Medicine 2025 conference participants for replay. To protect the privacy of participants, no breakouts, video feeds, or chats will be recorded. We also request that you refrain from recording or screen-grabbing any part of the course.
...
If you would like to practice with the materials from the course, go to the [GitHub repository](https://github.com/skadauke/intro-to-r-for-clinical-data-rmed2025), and click the green button labeled "Code" to download the repository as a .ZIP file.
